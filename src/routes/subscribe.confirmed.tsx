  ...
  head: () => ({
    meta: [
      { title: "You're subscribed — TheFullPicture.ai" },
      {
        name: "description",
        content:
          "Your TheFullPicture.ai newsletter subscription is confirmed. Here's when your first send arrives.",
      },
    ...
    <main className="mx-auto max-w-2xl px-4 py-16">
      <div className="rounded-md border border-border bg-card/60 p-8">
        ...
        <p className="mt-3 text-lg text-muted-foreground">
          Thank you — your subscription to the{" "}
          <strong className="text-foreground">{tier.name}</strong> is confirmed at{" "}
          {priceLabel(cadence, plan)}.
        </p>
        ...
        <p className="mt-6 text-sm text-muted-foreground">
          Your subscription doesn't just land the brief in your inbox — it keeps the AI pipeline
          running and TheFullPicture.ai alive. Thank you for backing it.
        </p>

        <p className="mt-4 text-sm text-muted-foreground">
          A receipt from Stripe and a welcome email are on their way. If the welcome email hasn't
          landed within a few minutes, check your spam folder and add us to your contacts so future
          sends arrive cleanly. You can change cadence or cancel any time from the link at the foot
          of every email.
        </p>
