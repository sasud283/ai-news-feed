...
export const Route = createFileRoute("/impressum")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Legal notice and provider identification for The Full Picture." },
...
const SECTIONS: { heading: string; paragraphs: React.ReactNode[] }[] = [
  ...
  },
  {
    ...
    paragraphs: [
      <>
        We collect only the email address you provide to subscribe. We do not sell or share your data with third
        parties. We use cookies on this site for analytics purposes only. For full details, see our{" "}
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12">
      ...
      <p className="mt-6 text-base leading-relaxed text-muted-foreground">
        The Full Picture is an independent AI news aggregator operated by Sarah Suda, based in Malta, European
        Union.
      </p>
