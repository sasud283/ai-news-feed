...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "The AI Brief" },
      {
...
function SiteFooter() {
  return (
    <footer className="mt-16 border-t border-border py-8">
      <div className="mx-auto max-w-3xl px-4 text-sm text-muted-foreground">
        Summaries on this site are generated by AI from the linked sources and may contain errors.{" "}
