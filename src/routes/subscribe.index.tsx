  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-12">
      ...
      <header className="mt-6 max-w-2xl">
        <p className="text-xs font-semibold tracking-widest text-brand-accent uppercase">Newsletter</p>
        ...
        {(["monthly", "yearly"] as const).map((option) => (
          <button
            ...
            className={`rounded px-4 py-2 text-sm font-semibold transition-colors ${
              plan === option ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:text-foreground"
            }`}
          >
              ...
              return (
                <button
                  ...
                  className={`rounded-md border p-6 text-left transition-colors ${
                    active ? "border-foreground ring-1 ring-foreground" : "border-border hover:bg-muted/50"
                  }`}
                >
                  ...
                  <span className="mt-4 block space-y-2">
                    {tier.points.map((point) => (
                      <span key={point} className="flex items-start gap-2 text-sm text-muted-foreground">
