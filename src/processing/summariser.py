...
Choose only central topics. Business: funding, deals, markets, results or strategy; a company mention alone is insufficient. Workforce redesign: organisations/jobs; public-service access: society/economy. Cyber: attacks, breaches, malware, fraud, defenses; a government victim alone is not a national initiative. Research: AI models/methods. Science/healthcare: AI use in medicine, biology, scientific discovery or space, not AI model research. Do not tag unrelated science. Patient or public-service effects may also fit daily life or society/economy. Data-center disputes: society/economy. Leadership includes leadership pipelines even when HR is the reporting lens. AI coworkers: people/jobs for worker experience; organisations for internal adoption. Education requires human learning or training. Synthetic-media misinformation or deepfakes: ethics and daily life. General product or customer-service harm is not ethics or equity without governance or disparate impact.
Tone:0 benefit,1 useful,2 bad,3 severe harm/abuse,4 novel,5 neutral,6 unclear,7 mixed. Deceptive synthetic media, unsupported medical hype, rejection of documented safety safeguards, and cultural misalignment or systematic failure are adverse (2). Hype proves no benefit; judge the main event.
